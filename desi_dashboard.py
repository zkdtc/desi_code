...
class DESI_DASHBOARD(object):
    ...
    def __init__(self):
        ...
        ## Input ###
        ############
        prod="realtime9" #product name  
        prod_dir="/global/cscratch1/sd/zhangkai/desi/" # base directory of product
        self.output_dir="/global/project/projectdirs/desi/www/users/zhangkai/desi_dashboard/"+prod+"/" # Portal directory for output html files
        self.output_url="https://portal.nersc.gov/project/desi/users/zhangkai/desi_dashboard/"+prod+"/" # corresponding URL
        prod_dir="/global/cscratch1/sd/zhangkai/desi/" # base directory of product
